...
INSERT INTO `datalist` VALUES ('0039 中国历史地震数据-780-1970', '免费', '地震、历史', '企业数据', '7', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0379 省、市、县地形起伏度数据', '会员免费', '中国省、市县级地形起伏度数据', '地理数据', '8', '2', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0039 中国历史地震数据-780-1970', '免费', '包括CSSCI(2019-2020)收录来源期刊目录568种，扩展版214', '企业数据', '9', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0379 省、市、县地形起伏度数据', '免费', '中国省、市县级地形起伏度数据', '企业数据', '10', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0341 中国地级市、区县夜光指数2014-2019', '免费', '夜间灯光指数数据是DMSP/OLS的1992-2013年全球遥感影像，包括三种非辐射定标的夜间灯光影像。\r\n三种全年平均影像分别是：无云观测频数影像、平均灯光影像和稳定灯光影像。', '企业数据', '11', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0067 全国幼儿园信息', '免费', '、区域范围：全国4、指标说明：计算方式包含在Excel表等六个', '地理数据', '12', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('510产业结构化数据集！', '免费', '、区域范围：全国4、指标说明：计算方式包含在Excel表等六个', '地理数据', '13', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0462全网独家！最新！空气流动系数数据2000-2019年！', '免费', '据是DMSP/OLS的1992-2020年全球遥感影像，包括三种非辐射定标的夜间灯光影像。三种全年平均影像分别是：无云观测频数影像、平均灯光影像和稳定灯光影像。稳定灯光', '地理数据', '14', '4', '已审核', '-1');
INSERT INTO `datalist` VALUES ('529中国省市县灯光数据合集！', '免费', '空气流动系数数据为环境经济学常用工具变量！\r\n数据为复旦大学陈诗一和陈登科教授（2018）在《雾霾污染、政府治理与经济高质量发展》一文中所用地级市空气流动系数面板数据。\r\n计算方式参考论文。\r\n论文附在分享的文件夹中。\r\n主要变量包括地级市、10米风速、边界层高度等。部分数据如下', '地理数据', '15', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0462全网独家！最新！空气流动系数数据2000-2019年！', '免费', '\r\n根据Global/Regional Estimates (V5.GL.02)，计算出国内PM2.5数据（单位：微克/立方米）', '地理数据', '16', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('510产业结构化数据集！', '免费', '据是DMSP/OLS的1992-2020年全球遥感影像，包括三种非辐射定标的夜间灯光影像。三种全年平均影像分别是：无云观测频数影像、平均灯光影像和稳定灯光影像。稳定灯光', '地理数据', '17', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0462全网独家！最新！空气流动系数数据2000-2019年！', '免费', '空气流动系数数据为环境经济学常用工具变量！\r\n数据为复旦大学陈诗一和陈登科教授（2018）在《雾霾污染、政府治理与经济高质量发展》一文中所用地级市空气流动系数面板数据。\r\n计算方式参考论文。\r\n论文附在分享的文件夹中。\r\n主要变量包括地级市、10米风速、边界层高度等。部分数据如下', '地理数据', '18', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('548 省市县-PM2.5数据合集', '免费', '\r\n根据Global/Regional Estimates (V5.GL.02)，计算出国内PM2.5数据（单位：微克/立方米）', '地理数据', '19', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('531WTO世界贸易报告', '免费', '世界贸易报告是WTO机构就全球贸易和经济发展状况发布的一份报告', '地理数据', '20', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0039 中国历史地震数据-780-1970', '免费', '据是DMSP/OLS的1992-2020年全球遥感影像，包括三种非辐射定标的夜间灯光影像。三种全年平均影像分别是：无云观测频数影像、平均灯光影像和稳定灯光影像。稳定灯光', '企业数据', '21', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0039 中国历史地震数据-780-1970', '会员免费', '\r\n根据Global/Regional Estimates (V5.GL.02)，计算出国内PM2.5数据（单位：微克/立方米）', '企业数据', '22', '2', '已审核', '-1');
INSERT INTO `datalist` VALUES ('531WTO世界贸易报告', '会员免费', '世界贸易报告是WTO机构就全球贸易和经济发展状况发布的一份报告', '企业数据', '23', '2', '已审核', '-1');
INSERT INTO `datalist` VALUES ('512全网最全！中国农村统计年鉴1985-2021！', '会员免费', '指数（干春晖泰尔指数）1、数据来源：中国统计年鉴及各省统', '企业数据', '24', '2', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0185 中国民政统计年鉴1949-2020', '会员免费', '世界贸易报告是WTO机构就全球贸易和经济发展状况发布的一份报告', '企业数据', '25', '3', '已审核', '-1');
INSERT INTO `datalist` VALUES ('512全网最全！中国农村统计年鉴1985-2021！', '会员免费', '指数（干春晖泰尔指数）1、数据来源：中国统计年鉴及各省统', '企业数据', '26', '2', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0185 中国民政统计年鉴1949-2020', '会员免费', '世界贸易报告是WTO机构就全球贸易和经济发展状况发布的一份报告', '企业数据', '27', '5', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0039 中国历史地震数据-780-1970', '会员免费', '构合理化高级化指数1、数据来源：各地级市统计年鉴2、时间跨度：2006-2019年 3、区域范围：全国4、指标说明：原始数据在分享文件中部分数据如下四、徐云德三', '地理数据', '28', '2', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0039 中国历史地震数据-780-1970', '会员免费', '指数（干春晖泰尔指数）1、数据来源：中国统计年鉴及各省统', '地理数据', '29', '4', '已审核', '-1');
INSERT INTO `datalist` VALUES ('512全网最全！中国农村统计年鉴1985-2021！', '免费', '指数（干春晖泰尔指数）1、数据来源：中国统计年鉴及各省统', '地理数据', '30', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0185 中国民政统计年鉴1949-2020', '免费', '510产业结构化数据集！', '地理数据', '31', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('548 省市县-PM2.5数据合集', '免费', '指数（干春晖泰尔指数）1、数据来源：中国统计年鉴及各省统', '企业数据', '32', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('512全网最全！中国农村统计年鉴1985-2021！', '免费', '指数（干春晖泰尔指数）1、数据来源：中国统计年鉴及各省统', '企业数据', '33', '0', '已审核', '-1');
INSERT INTO `datalist` VALUES ('0480中国商品交易市场统计年鉴2001-2020', '免费', '0480中国商品交易市1995-2021(中国高技术统计年鉴2001-2020', '企业数据', '34', '0', '已审核', '-1');
